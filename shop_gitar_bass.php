...
<html lang="en">
  ...
  <?php
      ...
      WHERE produk.id_jenis = 1 OR produk.id_jenis = 2
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="shop.php">Shop</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Gitar</strong></div>
        </div>
      </div>
    </div>
